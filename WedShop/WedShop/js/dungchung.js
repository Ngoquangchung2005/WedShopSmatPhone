...
function addFooter() {
    ...
    <!-- ============== Footer ============= -->
    <footer class="footer">
        <div class="footer-container plc">
            <!-- Company Info -->
            <div class="footer-section">
                <h3>LDD Phone Store</h3>
                <p>Chúng tôi cung cấp các sản phẩm điện thoại di động chính hãng với giá cả hợp lý và dịch vụ hậu mãi tốt nhất.</p>
            </div>
            <!-- Quick Links -->
            <div class="footer-section">
            ...
            <div class="footer-section">
                <h4>Liên hệ</h4>
                <p>Email: tungtnt.23ite@vky.dn.vn</p>
                <p>Điện thoại: 0123-456-789</p>
                <p>Địa chỉ: Hoà Quý, Ngũ Hành Sơn, Da Nang</p>
            </div>
            <!-- Social Links -->
            <div class="footer-section">
